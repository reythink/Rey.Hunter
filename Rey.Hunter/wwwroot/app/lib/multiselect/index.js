(function () {
    var app = angular.module('rey-multi-select', ['ui.select', 'ngSanitize']);
    ...
    app.directive('reyMultiSelect', function ($http) {
        return {
            restrict: 'E',
            templateUrl: '/app/lib/multiselect/index.html?r=' + Math.random(),
            scope: {
                reyPlaceholder: '@',
                reyAttrSelect: '@',
                reyAttrSelected: '@',
